"""
Django settings for readers_hut project.
...
SECRET_KEY = 'django-insecure-mgqmt7)9&ws)&mdo9)k($!vgqg)+q62t^s_$s$&py&2qsf=c)k'
...
WSGI_APPLICATION = 'readers_hut.wsgi.application'
